...
class User(AbstractBaseUser):
    ...
    type = models.CharField(max_length=20, choices=TypeDefine.USER_TYPES, default=TypeDefine.USER_TYPES[1][1])
...
class PublisherManager(models.Manager):
    def get_queryset(self, *args, **kwargs):
        return super().get_queryset(*args, **kwargs).filter(type=TypeDefine.USER_TYPES[0][0])
...
class Publisher(User):
    ...
    def save(self, *args, **kwargs):
        if not self.pk:
            self.type = TypeDefine.USER_TYPES[0][0]
